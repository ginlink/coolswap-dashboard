...
import { computeNumUnit, computeNumUnitAdapter } from './formatNum'
...
describe('#computeNumUnitAdapter', () => {
  const bigNum = new BigNumber(0.0001)
  it('should be 0.20', () => {
    expect(computeNumUnitAdapter(0.2)).toEqual('0.20')
  })

  it('should be 0.0020', () => {
    expect(computeNumUnitAdapter(0.002)).toEqual('0.0020')
  })

  it('should be false', () => {
    expect(computeNumUnitAdapter(0.002) === '0.00').toBeFalsy()
  })

  it('should be zero', () => {
    expect(computeNumUnitAdapter(0)).toEqual('0.00')
  })

  it('should be zero', () => {
    expect(computeNumUnitAdapter(bigNum)).toEqual('0.00')
  })
})
